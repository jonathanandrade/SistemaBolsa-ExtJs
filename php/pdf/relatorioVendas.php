...
class MYPDF extends TCPDF {
	...
	//load data
	$queryString = "SELECT idmovimento, movimento.sigla, descricao, quantidade, dataCompra, dataVenda, valorUnitario, total from movimento join empresa on movimento.sigla = empresa.sigla and movimento.login = empresa.login and movimento.tipo = 'V' and movimento.login = '$login'" or die(mysql_error());		
